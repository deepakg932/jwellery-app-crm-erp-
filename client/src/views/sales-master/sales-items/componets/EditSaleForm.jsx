...
const EditSaleForm = ({ onClose, onSave, sale, customers: propCustomers, customerGroups = [], onAddCustomer, loading = false }) => {
  const {
    items,
    branches,
    employees,
    ...
    if (sale) {
      ...
      const saleItems =
        sale.items?.map((item) => ({
          ...
          biller_by: item.biller_by || "", // Include biller field
        })) || [];
