...
export default function MaterialTableForm() {
  const {
    materials,
    metals,
    loading,
  ...
  const filteredMaterials = (materials || []).filter((item) =>
    ...
    item.metal_name.toLowerCase().includes(search.toLowerCase())
  );
  ...
  const handleUpdate = async (materialData) => {
    ...
    try {
      await updateMaterial(selectedItem._id, materialData);
  ...
  const handleDelete = async () => {
    ...
    try {
      await deleteMaterial(selectedItem._id);
  ...
  // Get metal name from materials array
  const getMetalNameForDisplay = (material) => {
    return material.metal_name || "N/A";
  };
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content rounded-3">
          <div className="modal-header border-bottom pb-3">
            <h5 className="modal-title fw-bold fs-5">Delete Material Type</h5>
            <button
              type="button"
              className="btn-close"
              onClick={() => {
          ...
          <div className="modal-body">
            <p>
              ...
              <strong>{selectedItem?.material_type}</strong>?
            </p>
          </div>
        ...
        <div className="card-body">
          <div className="row align-items-center mb-4">
            <div className="col-md-6">
              <h1 className="h3 fw-bold mb-2">Material Types</h1>
              <p className="text-muted mb-0">
                Manage material types with associated metals
              </p>
            </div>
            ...
            <div className="col-md-4">
              <div className="input-group">
                ...
                <input
                  ...
                  placeholder="Search material types or metals..."
                  value={search}
              ...
              {loading && materials.length === 0 ? (
                ...
                <tr>
                  <td colSpan="5" className="text-center py-4 text-muted">
                    {search
                      ? "No material types found for your search"
