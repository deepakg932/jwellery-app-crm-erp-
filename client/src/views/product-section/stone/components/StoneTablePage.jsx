...
export default function StoneTablePage() {
  ...
  const handleUpdate = async (stoneData, imageFile) => {
    ...
    try {
      await updateStone(selectedItem._id, {
  ...
  const handleDelete = async () => {
    ...
    try {
      await deleteStone(selectedItem._id);
        ...
        <div className="modal-content rounded-3">
          ...
          <div className="modal-body">
            <p>
              ...
              <strong>{selectedItem?.stone_type}</strong>?
            </p>
          </div>
        ...
        <div className="card-body">
          <div className="row align-items-center mb-4">
            <div className="col-md-6">
              <h1 className="h3 fw-bold mb-2">Stone Type Management</h1>
              <p className="text-muted mb-0">
                Manage your stones type in a table layout
              </p>
            </div>
