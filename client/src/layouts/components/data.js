...
//     isTitle: true,
//   },
//   // UPDATED: Product Master without Price Master
//   {
//     key: "product-section",
//     label: "Product Master",
//     icon: LuPackage2,
...
//     ],
//   },
//   // NEW: Price Master as separate top-level menu
//   {
//     key: "price-master",
//     label: "Price Master",
//     icon: LuBadgeDollarSign,
...
export const menuItems = [
  ...
  // Product Master without Price Master
  {
    key: "product-section",
    label: "Product Master",
    icon: LuPackage2,
  ...
  // Price Master as separate top-level menu
  {
    key: "price-master",
    label: "Price Master",
    icon: LuBadgeDollarSign,
  ...
  // UPDATED: Branch as separate section
  {
    ...
    children: [
      {
        key: "branch-type",
        label: "Branch Type",
        url: "/branch-management/branch-type",
      },
      {
        key: "branch",
        label: "Branch",
  ...
  // UPDATED: Inventory without branch items
  {
    key: "inventory managment",
