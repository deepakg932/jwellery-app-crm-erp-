...
export const createFormData = (data, fileFields = ['images']) => {
  ...
  Object.keys(data).forEach(key => {
    // Skip file fields
    if (!fileFields.includes(key) && data[key] !== undefined && data[key] !== null) {
...
export const API_ENDPOINTS = {
  ...
  updateStoneType: (id) => endpoint(PATHS.STONE_TYPE, ROUTES.UPDATE_STONE_TYPE, id),
  deleteStoneType: (id) => endpoint(PATHS.STONE_TYPE, ROUTES.DELETE_STONE_TYPE, id),
  ...
  updateStonePurity: (id) => endpoint(PATHS.STONE_PURITY, ROUTES.UPDATE_PURITY, id),
  deleteStonePurity: (id) => endpoint(PATHS.STONE_PURITY, ROUTES.DELETE_PURITY, id),
  ...
  updateCategory: (id) => endpoint(PATHS.CATEGORIES, ROUTES.UPDATE_CATEGORY, id),
  deleteCategory: (id) => endpoint(PATHS.CATEGORIES, ROUTES.DELETE_CATEGORY, id),

  // SubCategories
  getSubCategories: () => endpoint(PATHS.SUB_CATEGORIES, ROUTES.GET_SUB_CATEGORIES),
  createSubCategory: () => endpoint(PATHS.SUB_CATEGORIES, ROUTES.CREATE_SUB_CATEGORIES),
  updateSubCategory: (id) => endpoint(PATHS.SUB_CATEGORIES, ROUTES.UPDATE_SUB_CATEGORIES, id),
  deleteSubCategory: (id) => endpoint(PATHS.SUB_CATEGORIES, ROUTES.DELETE_SUB_CATEGORIES, id),
  ...
  getMakingStages: () => endpoint(PATHS.MAKING_STAGES, ROUTES.GET_MAKING_STAGES),
  createMakingStage: () => endpoint(PATHS.MAKING_STAGES, ROUTES.CREATE_MAKING_STAGE),
  updateMakingStage: (id) => endpoint(PATHS.MAKING_STAGES, ROUTES.UPDATE_MAKING_STAGE, id),
  deleteMakingStage: (id) => endpoint(PATHS.MAKING_STAGES, ROUTES.DELETE_MAKING_STAGE, id),

  // ========== MAKING SUB-STAGE OPERATIONS ==========
  getMakingSubStages: () => endpoint(PATHS.MAKING_SUB_STAGES, ROUTES.GET_MAKING_SUB_STAGES),
  createMakingSubStage: () => endpoint(PATHS.MAKING_SUB_STAGES, ROUTES.CREATE_MAKING_SUB_STAGE),
  updateMakingSubStage: (id) => endpoint(PATHS.MAKING_SUB_STAGES, ROUTES.UPDATE_MAKING_SUB_STAGE, id),
  deleteMakingSubStage: (id) => endpoint(PATHS.MAKING_SUB_STAGES, ROUTES.DELETE_MAKING_SUB_STAGE, id),
  ...
  updateCostType: (id) => endpoint(PATHS.COST_TYPES, ROUTES.UPDATE_COST_TYPE, id),
  deleteCostType: (id) => endpoint(PATHS.COST_TYPES, ROUTES.DELETE_COST_TYPE, id),

  // ========== PRICE MAKING OPERATIONS ==========
  getPriceMakings: () => endpoint(PATHS.PRICE_MAKING, ROUTES.GET_PRICE_MAKINGS),
  createPriceMaking: () => endpoint(PATHS.PRICE_MAKING, ROUTES.CREATE_PRICE_MAKING),
  updatePriceMaking: (id) => endpoint(PATHS.PRICE_MAKING, ROUTES.UPDATE_PRICE_MAKING, id),
  deletePriceMaking: (id) => endpoint(PATHS.PRICE_MAKING, ROUTES.DELETE_PRICE_MAKING, id),
