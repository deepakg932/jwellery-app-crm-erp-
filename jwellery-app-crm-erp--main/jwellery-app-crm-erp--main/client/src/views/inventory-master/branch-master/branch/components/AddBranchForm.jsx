...
// }) => {
//   const [formData, setFormData] = useState({
//     branch_name: "", // This will be mapped to branch_name in backend
//     branch_type: "",
//     contact_person: "",
//     address: "",
//     phone: "",
...
//     const payload = {
//       branch_name: formData.branch_name.trim(),
//       branch_type: formData.branch_type, // Send branch_type ID
...
//                   type="text"
//                   name="contact_person"
//                   className={`form-control form-control-lg ${errors.contact_person ? "is-invalid" : ""}`}
...
//                     disabled={loading}
//                   />
//                   <label className="form-check-label fw-medium" htmlFor="isWarehouse">
//                     Is Warehouse?
//                   </label>
//                   <div className="form-text">
//                     Check if this branch is a warehouse
//                   </div>
//                 </div>
//               </div>
...
const AddBranchForm = ({
  ...
  loadingTypes = false,
  typesError = "",
  existingPhones = [] // Add this prop to pass existing phone numbers for validation
}) => {
  const [formData, setFormData] = useState({
    branch_name: "",
    branch_type: "",
  ...
  const validateForm = () => {
    ...
    } else if (existingPhones && existingPhones.includes(phoneValue)) {
        ...
        <div className="modal-content rounded-3">
          ...
          <form onSubmit={handleSubmit}>
            <div className="modal-body">
              ...
              {/* Phone - With duplicate validation */}
              <div className="mb-3">
                <label className="form-label fw-medium">
                  Phone Number <span className="text-danger">*</span>
                </label>
                ...
                <small className="text-muted">
                  Mobile number must be unique across all branches
                </small>
              </div>
