...
export const JobType = ['custom_order', 'design', 'sample', 'making', 'repair', 'other', 'order', 'stock'];
export const JobStage = ['design', 'cad', 'casting', 'filing', 'setting', 'polishing', 'plating', 'quality', 'packaging', 'qc'];
...
export const CostType = ["per_gram", "per_piece", "fixed"];
