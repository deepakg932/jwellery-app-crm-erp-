...
export const createInventoryItem = async (req, res) => {
  try {
    const { item_name, inventory_category_id, unit_id, product_id, track_by, weight, quantity, branch, barcode } = req.body;
...
export const updateInventoryItem = async (req, res) => {
  try {
    ...
    let updateData = {
      ...
      branch: branch ?? existingItem.branch,
